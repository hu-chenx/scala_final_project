...
class TFIDFSpec extends FlatSpec{
   ...
   val accessToken = "EAACEdEose0cBAJXwwRKGTdHufqJrRVrZA5CyZCw9SnWmOsmjvamyoYZB64QbtZAQRJrqb9sS5T18KZAamwJIJ2C0VRO9ViBgc1gQulZBbyjrIZCm9wUWWZAZClQGKAHcAiSR0iqdlm9n0J0ZBQvycwdrV5qR0CfGQVExXFnDmuNL97mQZDZD"
   ...
   "tf idf value test of sample file" should "get value pre-calcualted" in {
    ...
    "calculate similarity " should "get 1.0 when compared with same vector" in {
      ...
      val context = TFIDF.initialSpark
      val rdd = context.wholeTextFiles(filePath)
